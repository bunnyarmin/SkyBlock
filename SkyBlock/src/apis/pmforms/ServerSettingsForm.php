...
class ServerSettingsForm extends CustomForm
{
    ...
    #[ArrayShape(["content" => "\SkyBlock\apis\pmforms\element\CustomFormElement[]", "icon" => "\SkyBlock\apis\pmforms\FormIcon|null"])] protected function serializeFormData(): array
    {
