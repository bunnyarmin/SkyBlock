...
namespace SkyBlock\apis\pmforms;
...
use SkyBlock\apis\pmforms\element\CustomFormElement;
...
class CustomForm extends BaseForm
{
    ...
    #[ArrayShape(["content" => "\SkyBlock\apis\pmforms\element\CustomFormElement[]"])] protected function serializeFormData(): array
    {
        return [
